(function executeRule(current, previous /*null when async*/ ) {
    ...
    function getEngagement() {
        ...
        // ** Add ref part to create control artifact part
    ...
    function createAuditArtifact(auditRecId) {
        ...
        if (!controlArtifactRec.next()) {
            ...
            controlArtifactRec.u_engagement = auditRecId;
            ...
            controlArtifactRec.u_display_name = getRecordDisplay(current.table_name, current.table_sys_id);
            controlArtifactRec.u_metric_record = current.table_sys_id;
            controlArtifactRec.u_engagement_type = getTableDisplay(current.table_name, current.table_sys_id);
            controlArtifactRec.u_attachment_image = gs.getProperty('glide.servlet.uri') + 'sys_attachment.do?sys_id=' + current.sys_id;
    ...
    gs.info('DV - ' + getEngagement());
    createAuditArtifact(getEngagement());
